...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        floorMaterial.setReflectivity(1);
        ...
        middle.getMaterial().setReflectivity(1);
        ...
        right.getMaterial().setReflectivity(1);
        ...
        Light pointLight = new Light(new Color(1, 1, 1), new Point(-20, 10, -10));
...
//        world.addGeometryObject(rightWall);
        ...
        Camera camera = new Camera(1920, 1080, 2);
